  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        label: "Activity",
        icon: Activity,
        perms: [ProxiesPermissions.UsageEvents.View],
      },
      {
      ...
      },
      {
        ...
        label: "Policies",
        icon: ShieldCheck,
        perms: [ProxiesPermissions.Policies.View],
      },
      {
        to: "/proxies/health-check-targets",
        label: "Health Checks",
        icon: HeartPulse,
        perms: [ProxiesPermissions.HealthCheckTargets.View],
      },
    ],
  },
  {
