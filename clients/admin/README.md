...
Operator console for the FS Proxy .NET Starter Kit. Built with React 19, Vite 7, TypeScript, TanStack Query, React Router and Tailwind 4 + shadcn/ui.
...
- Node.js 20+
- The API running locally (`dotnet run --project src/Host/FS.Proxy.Api`, defaults to `http://localhost:5030`)
