...
With one migrations project per provider (`FS.Proxy.Migrations.PostgreSQL`,
`FS.Proxy.Migrations.MSSQL`), forgetting the second one **fails nothing**: the build passes, the
