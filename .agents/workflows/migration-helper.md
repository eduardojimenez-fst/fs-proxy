...
- All migrations live in **one** project, `src/Host/FS.Proxy.Migrations.PostgreSQL`, foldered **per module/context** (`Catalog/`, `Identity/`, …), each with its own `{X}DbContextModelSnapshot`.
