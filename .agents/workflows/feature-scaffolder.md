...
You orchestrate feature delivery for FS Proxy. **You do not duplicate code templates** — each phase
...
## Verify
```bash
dotnet build src/FS.Proxy.slnx && dotnet test src/Tests/{X}.Tests
