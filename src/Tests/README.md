...
This folder contains solution-wide architecture tests for the FS Proxy .NET 10 Starter Kit. The goal is to automatically enforce layering, dependency, and naming rules as the codebase evolves.
...
- Run all tests (including architecture tests): `dotnet test src/FS.Proxy.slnx`.
