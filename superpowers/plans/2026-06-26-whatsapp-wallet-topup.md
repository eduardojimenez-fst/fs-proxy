...
- `src/Host/FS.Proxy.Migrations.PostgreSQL/Billing/` — one new migration + updated snapshot.
...
- Create: migration files under `src/Host/FS.Proxy.Migrations.PostgreSQL/Billing/`
...
dotnet ef migrations add WhatsAppWalletTopup \
  ...
  --project src/Host/FS.Proxy.Migrations.PostgreSQL/FS.Proxy.Migrations.PostgreSQL.csproj \
  --startup-project src/Host/FS.Proxy.Api/FS.Proxy.Api.csproj \
  --output-dir Billing
```
...
```bash
git add src/Modules/Billing/Modules.Billing/Data src/Host/FS.Proxy.Migrations.PostgreSQL/Billing
...
Run: `dotnet build src/FS.Proxy.slnx && dotnet test src/Tests/Architecture.Tests/Architecture.Tests.csproj`
